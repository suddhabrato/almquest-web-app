...
const RegForm = () => {
  ...
  const [donorType, setDonorType] = useState("Food Chain");
  const handleClickFoodChain = () => {
    setDonorType("Food Chain");
  };
  const handleClickOrganisation = () => {
    setDonorType("Organisation");
  };
  ...
  const activeDonorClass =
    "px-5 py-3 text-sm mt-2 text-white capitalize bg-blue-600 md:py-3 rounded-xl md:px-12";
  const inactiveDonorClass =
    "px-5 py-3 mx-4 text-sm mt-2 text-blue-600 capitalize transition-colors duration-300 md:py-3 dark:text-blue-400 dark:hover:text-white focus:outline-none hover:bg-blue-600 hover:text-white rounded-xl md:mx-8 md:px-12"
    return (
    <section className="bg-white dark:bg-gray-900">
      <div className="flex justify-center min-h-screen">
        <div
          className="hidden bg-cover max-w-full h-auto lg:block lg:w-2/5"
          style={{
            backgroundImage:
          ...
          <div className="w-full">
            ...
            <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-sm invisible peer-invalid:visible text-pink-600">
              ...
              {userType == "Donor" ? (
                <div>
                  ...
                  <div>
                    ...
                    <button
                    onClick={handleClickFoodChain}
                    className={
                      userType == "Food Chain" ? activeDonorClass : inactiveDonorClass
                    }
                    >
                      Food Chain
                    </button>
                    ...
                    className={
                      userType == "Organisation" ? activeDonorClass : inactiveDonorClass
                    }
                    >
                      Organisation
                    </button>
                    ...
                    className={
                      userType == "Individual" ? activeDonorClass : inactiveDonorClass
                    }
                    >
                      Individual
                    </button>
