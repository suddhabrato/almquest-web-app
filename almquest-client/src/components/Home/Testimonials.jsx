        ...
        <section className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 lg:grid-cols-2 xl:grid-cols-3">
          <div className="grid grid-rows-1 place-content-between p-8 border rounded-lg dark:border-gray-700">
            <p className="leading-loose text-gray-500 dark:text-gray-400">
              “We have been in business for almost a decade now and the 
              most morally derogatory problem that we had faced was the amount of food 
              we had to throw away on a daily basis because we simply did not have
              the means to donate. But now with AlmQuest we can do that effortlessly.”
            </p>
          ...
          <div className="grid grid-rows-1 place-content-between p-8 border rounded-lg dark:border-gray-700">
            <p className="leading-loose text-gray-500 dark:text-gray-400">
              “We are a group of teachers at a High School in a remote area in the Nadia district of West Bengal, India.
              We have a lot of under-nourished population in the region surrroundingour school. Government provided food rations
              only help some and despite our best intention of feeding these people, we never had a food source to make that feasible.
