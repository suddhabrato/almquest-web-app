...
const Profile = () => {
  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="flex justify-center min-h-screen mx-4 mt-16">
        <div className="rounded-lg shadow-lg border-gray-100 dark:border-gray-700 border-2 flex-col items-center h-full w-full max-w-4xl p-8 lg:px-12 lg:w-3/5">
