    ...
    <>
      ...
      >
        ...
        <div className="flex items-center text-gray-700 dark:text-gray-200 px-2">
          ...
          <h1 className="mx-2 w-full text-lg text-gray-700 dark:text-white truncate">
        ...
        {userType === "donor" ? (
          <>
            ...
            <div className="flex items-center text-gray-700 dark:text-gray-200 px-2">
              ...
              <h1 className="mx-2 text-lg text-gray-700 capitalize dark:text-white">
                {donor.distanceRange} Kilometres
              </h1>
            </div>
          </>
        ) : (
          <>
            ...
            <div className="flex items-center text-gray-700 dark:text-gray-200 px-2">
              ...
              <h1 className="mx-2 text-lg text-gray-700 capitalize dark:text-white">
                {distributor.distanceRange} Kilometres
              </h1>
            </div>
          </>
        )}
